                    ...
                    <?php foreach($modules_actions as $row){ 
                      ...
                      <?php if ($row['sub_module_action_id'] =='delete'){?>
                       onclick="deletee();" <?php }
                        ...
                        {?>
                        href ="<?php echo $module_id.'/'.$row['sub_module_action_id'];?>"
                      <?php } ?> 
              ...
              <?php }}?>               
                     <button class="btn btn-sm" onclick="window.print()"> <i class="fa fa-print"></i> PRINT </button>
                            ...
                            <tbody>
                                ...
                                <?php if(isset($departments)) : foreach ($departments->result_array() as $row):?>
                                <tr>
                                  <td>
                                    <span class="center">
                                      <input type="checkbox" class="cc" name="department_id[]" value="<?php echo $row['department_id'];?>" />
                                    </span>                          
                                  </td>
                      ...
                      <li><a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['department_id'];?>"> 
                    ...
                    <i class="<?php echo $roww['icon'];?>"></i> 
                       ...
                       <li><a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['department_id'];?>"> 
                     ...
                     function deletee()
                      {
                          ...
                          jQuery('.cc:checked').each(function(i,e){
                            department_id.push(jQuery(this).val());
                          });
                          if(department_id ==''){
                            alert('PLEASE SELECT ATLEAT ONE DEPARTMENT TO DELETE FROM THE LIST!');
                          }else{
                                   if(confirm('Are you sure ????'))
                                  {
                                    jQuery.post("Department/delete",
                                    {
