            ...
            if(count($modules_actionss) > 0)
              ...
              <?php }}?>               
                     <button class="btn btn-sm" onclick="window.print()"> <i class="fa fa-print"></i> PRINT </button>
                        ...
                        <th></th>
											...
											<tr>
												<td>
													<span class="center">
                           							 <input type="checkbox" class="cc" name="branch_id[]" value="<?php echo $row['branch_id'];?>" />
                          							</span>                          </td>
                      ...
                      <li><a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['branch_id'];?>"> 
                    ...
                    <i class="<?php echo $roww['icon'];?>"></i> 
                       ...
                       <li><a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['branch_id'];?>"> 
                     ...
                     function deletee()
                      {
                          ...
                          jQuery('.cc:checked').each(function(i,e){
                            branch_id.push(jQuery(this).val());
                          });
                          if(branch_id ==''){
                            alert('PLEAS SELECT ATLEAT ONE BRANCH TO DELETE FROM THE LIST!');
                          }else{
                                   if(confirm('Are you sure ????'))
                                  {
                                    jQuery.post("Branch/delete",
                                    {
                                       branch_id : branch_id
                                    },
