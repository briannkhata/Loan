...
$(function() {
	...
	progressCounter('#hours-available-progress2', 38, 2, "#F06292", 0.68, "icon-watch text-pink-400", 'Hours available', '64% average')
	...
	progressCounter('#goal-progress2', 38, 2, "#5C6BC0", 0.82, "icon-trophy3 text-indigo-400", 'Productivity goal', '87% average')
	progressCounter('#goal-progress3', 38, 2, "#5C6BC0", 0.82, "icon-trophy3 text-indigo-400", 'Productivity goal', '87% average')
